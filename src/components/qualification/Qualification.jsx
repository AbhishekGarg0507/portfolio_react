            ...
            <div className="qualification__sections">
                ...
                >
                    ...
                    <div className="qualification__data">
                        ...
                        <div>
                            <h3 className="qualification__title">B.voc - Software development</h3>
                            <span className="qualification__subtitle">Punjabi University - Patiala</span>
                            <div className="qualification__calender">
                                <i className="uil uil-calender-alt">2017-2020</i>
                            </div>
                        </div>
                ...
                <div className={toggleState === 2 ? "qualification__content qualification__content-active" : "qualification__content"}>
                    <div className="qualification__data">
                        <div>
                            <h3 className="qualification__title">Software Engineer Intern - Angular</h3>
                            <span className="qualification__subtitle">Robozx PVT LTD - Kurukshetra</span>
                            <div className="qualification__calender">
                                <i className="uil uil-calender-alt">June 2023 - Jan 2024</i>
                            </div>
                        </div>
                    ...
                    <div className="qualification__data">
                        ...
                        <div>
                            <h3 className="qualification__title">Advanced Java - Training</h3>
